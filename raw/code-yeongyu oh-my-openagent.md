...
source: "https://github.com/code-yeongyu/oh-my-openagent/blob/dev/README.zh-cn.md"
author:
published:
created: 2026-04-09
...
> **Building in Public**
> 
> 维护者正在使用 Jobdori 实时开发和维护 oh-my-opencode。Jobdori 是基于 OpenClaw 深度定制的 AI 助手。 每个功能开发、每次修复、每次 Issue 分类，都在 Discord 上实时进行。
> 
> [![[raw/assets/d8e3eb04d9162edba801bc93fbb0f79d_MD5.png]]](https://discord.gg/PUwSMR9XNk)
> 
> [**→ 在 #building-in-public 频道中查看**](https://discord.gg/PUwSMR9XNk)

> [!note] Note
> [![[raw/assets/b1fa4e734b2ffbb2e456537fe1721d30_MD5.png]]](https://sisyphuslabs.ai/)
> 
...
> 加入我们！
> 
> |  | 加入我们的 [Discord 社区](https://discord.gg/PUwSMR9XNk) ，与贡献者及其他 `oh-my-opencode` 用户交流。 |
> | --- | --- |
> |  | 关于 `oh-my-opencode` 的新闻和更新过去发布在我的 X 账号上。   因为账号被意外停用，现在由 [@justsisyphus](https://x.com/justsisyphus) 代为发布更新。 |
> |  | 在 GitHub 上关注 获取更多项目信息。 |
...
> “如果你们能说服 @yeon\_gyu\_kim，赶紧招募他。这个人彻底改变了 opencode。”  
...
或者你可以直接去读 [安装指南](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/guide/installation.md) ，但说真的，让 Agent 去干吧。人类配环境总是容易敲错字母。
...
| [![[raw/assets/328aa21719748ef127cb2886f3db9428_MD5.png]]](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/.github/assets/sisyphus.png) | [![[raw/assets/b7b3cfa953101589fbeebe6731a20a0e_MD5.png]]](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/.github/assets/hephaestus.png) |
| --- | --- |
...
每一个 Agent 都针对其底层模型的特点进行了专门调优。你无需手动来回切换模型。 [阅读背景设定了解更多 →](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/guide/overview.md)
...
**想看所有的硬核功能说明吗？** 点击查看 **[详细特性文档 (Features)](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/reference/features.md)** ，深入了解 Agent 架构、Hook 流水线、核心工具链和所有的内置 MCP 等等。

---

> **第一次用 oh-my-opencode？** 阅读 **[概述](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/guide/overview.md)** 了解你拥有哪些功能，或查看 **[编排指南](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/guide/orchestration.md)** 了解 Agent 如何协作。
...
**想知道做这个插件的哲学理念吗？** 阅读 [Ultrawork 宣言](https://github.com/code-yeongyu/oh-my-openagent/blob/dev/docs/manifesto.md) 。
